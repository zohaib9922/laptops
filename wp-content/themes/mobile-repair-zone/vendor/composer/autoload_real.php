...
class mobile_repair_zone_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function mobile_repair_zone_loadClassLoader($class)
    {
    ...
    public static function mobile_repair_zone_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
