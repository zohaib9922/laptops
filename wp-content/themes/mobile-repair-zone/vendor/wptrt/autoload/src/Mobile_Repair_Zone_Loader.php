...
class Mobile_Repair_Zone_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function mobile_repair_zone_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function mobile_repair_zone_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function mobile_repair_zone_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function mobile_repair_zone_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->mobile_repair_zone_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function mobile_repair_zone_load( $class ) {
