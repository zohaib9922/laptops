...
class Ajax extends Lib\Base\Ajax
{
    ...
    public static function downloadIcs()
    {
        ...
        if ( $userData->load() && $userData->getOrderId() ) {
            ...
            $ics = Lib\Utils\Ics\Feed::createFromBookingData( $userData, InfoText::replace( Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_ics_customer_template' ), InfoText::getCodes( Steps::DONE, $userData ), false, false ) );
