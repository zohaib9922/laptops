var bookly = (function ($) {
	...
	*/
	...
	} // (510:8) {#if showServiceInfo && serviceId && services[serviceId].hasOwnProperty('info') && services[serviceId].info !== ''}
	...
	} // (528:8) {#if showStaffInfo && staffId && staff[staffId].hasOwnProperty('info') && staff[staffId].info !== ''}
	...
	} // (575:0) {#if showServiceInfo && serviceId && services[serviceId].hasOwnProperty('info') && services[serviceId].info !== ''}
	...
	} // (580:0) {#if showStaffInfo && staffId && staff[staffId].hasOwnProperty('info') && staff[staffId].info !== ''}
	...
	function instance$1($$self, $$props, $$invalidate) {
	  ...
	  function onCategoryChange(event) {
	    ...
	    if (categoryId) {
	      $$invalidate(60, categorySelected = true);
	      ...
	      $$invalidate(60, categorySelected = false);
	    }
	  }

	  function onServiceChange(event) {
	    var dateMin = false;
	    $$invalidate(64, srvMinCapacity = false);
	    $$invalidate(63, srvMaxCapacity = false);
	  ...
	  $$self.$$set = function ($$props) {
	    ...
	    if ("staffNameWithPrice" in $$props) $$invalidate(52, staffNameWithPrice = $$props.staffNameWithPrice);
	    if ("collaborativeHideStaff" in $$props) $$invalidate(53, collaborativeHideStaff = $$props.collaborativeHideStaff);
	    if ("showRatings" in $$props) $$invalidate(54, showRatings = $$props.showRatings);
	    ...
	    if ("maxQuantity" in $$props) $$invalidate(55, maxQuantity = $$props.maxQuantity);
	    ...
	    if ("date_from_element" in $$props) $$invalidate(56, date_from_element = $$props.date_from_element);
	  };
	  ...
	  $$self.$$.update = function () {
	    ...
	    /*servicesPerLocation, lookupLocationId, staffNameWithPrice, collaborativeHideStaff, showRatings, categories, categorySelected, maxCapacity, maxQuantity*/
	    1911685120 | $$self.$$.dirty[2] &
	    /*srvMinCapacity, srvMaxCapacity, minCapacity*/
	    7) {
	      {
	        $$invalidate(59, lookupLocationId = servicesPerLocation && locationId ? locationId : 0);
	          ...
	          if (!locationId || id in locations[locationId].staff) {
	            if (!serviceId) {
	              ...
	              $__default['default'].each(staffMember.services[serviceId].locations, function (locId, locSrv) {
	                ...
	                $$invalidate(64, srvMinCapacity = srvMinCapacity ? Math.min(srvMinCapacity, locSrv.min_capacity) : locSrv.min_capacity);
	                $$invalidate(63, srvMaxCapacity = srvMaxCapacity ? Math.max(srvMaxCapacity, locSrv.max_capacity) : locSrv.max_capacity);
	        ...
	        $$invalidate(61, maxCapacity = serviceId ? staffId ? lookupLocationId in staff[staffId].services[serviceId].locations ? staff[staffId].services[serviceId].locations[lookupLocationId].max_capacity : 1 : srvMaxCapacity ? srvMaxCapacity : 1 : 1);
	        $$invalidate(62, minCapacity = serviceId ? staffId ? lookupLocationId in staff[staffId].services[serviceId].locations ? staff[staffId].services[serviceId].locations[lookupLocationId].min_capacity : 1 : srvMinCapacity ? srvMinCapacity : 1 : 1);
	...
	var ChainItem = /*#__PURE__*/function (_SvelteComponent) {
	  ...
	  function ChainItem(options) {
	    ...
	    init(_assertThisInitialized(_this), options, instance$1, create_fragment$1, safe_not_equal, {
	      ...
	      staffNameWithPrice: 52,
	      collaborativeHideStaff: 53,
	      showRatings: 54,
	      showServiceInfo: 3,
	      showStaffInfo: 4,
	      maxQuantity: 55,
